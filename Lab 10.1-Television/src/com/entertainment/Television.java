...
//        boolean isConnected = verifyInternetConnection(); Does not work, just an example
    ...
    public void setBrand(String brand) throws InvalidBrandException {
        if (isValidBrand(brand)) {
            ...
            throw new InvalidBrandException("Invalid brand: " + brand + ", valid brands are " +
...
//        }
    ...
    public void setVolume(int volume) throws IllegalArgumentException {
        ...
        if (MIN_VOLUME <= volume && volume <= MAX_VOLUME ) {
            ...
            throw new IllegalArgumentException(String.format ("Invalid volume %s, valid range %s-%s", volume, MIN_VOLUME, MAX_VOLUME));
...
//        return "com.entertainment.Television: brand=" + getBrand() + ", volume=" + getVolume() + ", display type=" + getDisplay();
    }
