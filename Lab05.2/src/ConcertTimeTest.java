...
class ConcertTimeTest {
    ...
    public static void testLiveConcert() {
        // TODO
//        ZoneId concertLocation = ZoneId.of("America/Toronto");
//        ZonedDateTime concertLocation = ZonedDateTime.of(LocalDateTime.of(2020, 6, 18, 19, 0), "America/Toronto");
//        ZonedDateTime perthAus = concertLocation.withZoneSameInstant(ZoneId.of("Australia/Perth"));
//        System.out.println(perthAus);
    }
}