...
/*        try (BufferedReader reader = new BufferedReader(new FileReader("famous-poem.txt"))) {
    ...
    private static void writePoem() {
       String haiku = "I have had problems...\n" +
        ...
        /*try (PrintWriter out = new PrintWriter((new FileWriter("chad-haiku.txt")))) {
            out.println("A drink of darkness");
            out.println("Keeps the senses awakened");
            out.println("But the mind still sleeps");
        }
        catch (IOException e) {
            e.printStackTrace();
        }*/
